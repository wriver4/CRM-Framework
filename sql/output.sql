...
Estimate# INT(11),
Stage VARCHAR( 100 ),
ProposalSentDate INT(11),
ScheduledDate INT(11),
StructureType VARCHAR( 100 ),
LeadSource INT(11),
LeadLostNotes VARCHAR( 100 ),
PlansSubmitted INT(11),
StructureDescription VARCHAR( 100 ),
StructureOther DECIMAL( 10 , 2 ),
SiteVisitBy INT(11),
PictureSubmitted VARCHAR( 100 ),
Referedto INT(11),
PictureUploadLink DECIMAL( 10 , 2 ),
PlansUploadLink DECIMAL( 10 , 2 ),
ExistingClient INT(11),
GetUpdates VARCHAR( 100 ),
HearAbout INT(11),
HearAboutOther DECIMAL( 10 , 2 ),
StructureAdditional DECIMAL( 10 , 2 ),
LeadNotes VARCHAR( 100 ),
ProspectNotes DECIMAL( 10 , 2 ),
LeadLost INT(11),
SiteVisitCompleted INT(11),
Closer INT(11),
ReferredServices INT(11),
Assignedto INT(11),
Referred INT(11),
SiteVisitDate INT(11),
DateQualified INT(11),
ContactedDate INT(11),
ReferralDone INT(11),
JDReferralNotes INT(11),
ClosingNotes DECIMAL( 10 , 2 ),
ProspectLost INT(11),
ToContracting INT(11),
Plans&Pics INT(11)
);

/* INSERT QUERY */
INSERT INTO TABLE_NAME( Name(s),Phone,Email,Address,Estimate#,Stage,ProposalSentDate,ScheduledDate,StructureType,LeadSource,LeadLostNotes,PlansSubmitted,StructureDescription,StructureOther,SiteVisitBy,PictureSubmitted,Referedto,PictureUploadLink,PlansUploadLink,ExistingClient,GetUpdates,HearAbout,HearAboutOther,StructureAdditional,LeadNotes,ProspectNotes,LeadLost,SiteVisitCompleted,Closer,ReferredServices,Assignedto,Referred,SiteVisitDate,DateQualified,ContactedDate,ReferralDone,JDReferralNotes,ClosingNotes,ProspectLost,ToContracting,Plans&Pics )
VALUES
(
