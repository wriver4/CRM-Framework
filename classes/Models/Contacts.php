...
class Contacts extends Database
{
    ...
    private function extract_contact_data_from_lead($leadData)
    {
        ...
        return [
            ...
            'contact_type' => $leadData['contact_type'] ?? 1, // Use lead contact type
    ...
    public function create_contact($data)
    {
        $sql = "INSERT INTO contacts (
            prop_id, contact_type, first_name, family_name, full_name, 
    ...
    public function update_contact($id, $data)
    {
        ...
        $sql = "UPDATE contacts SET 
            prop_id = :prop_id, contact_type = :contact_type,
    ...
    {
        $sql = 'SELECT id, contact_type, full_name, phones, emails from contacts WHERE status = 1';
    ...
    {
        $sql = 'SELECT id, contact_type, full_name, phones, emails from contacts';
        $stmt = $this->dbcrm()->query($sql);
        $stmt->execute();
        $results = $stmt->fetchAll();
        return $results;
