...
require LANG . '/en.php';
$title = $lang['prospect_edit'] ?? 'Edit Prospect';
...
<form action="post.php"
    ...
    <div class="card-body bg-light py-3">
      <div class="d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center">
          ...
          <span class="fs-4 fw-bold text-dark">Prospect #<?= htmlspecialchars($lead_id ?? 'N/A') ?></span>
          <input type="hidden"
                 name="lead_id"
  ...
  <button type="submit"
          ...
          value="submit"
          tabindex="0">
    <?= $lang['prospect_update'] ?? 'Update Prospect'; ?>
  </button>
</form>
