 ...
 * 
 * Modal forms for creating and editing calendar events
 * Includes both event form modal and event detail modal
 */
?>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="eventForm">
              ...
              <div class="mb-3">
                ...
                <select class="form-select" id="event_type" name="event_type" required>
                  <?php foreach ($event_types as $type): ?>
                    <option value="<?= $type['id'] ?>" data-color="<?= $type['color'] ?>">
              ...
              <div class="mb-3">
                ...
                <select class="form-select" id="priority" name="priority">
                  <?php foreach ($priorities as $priority): ?>
                    <option value="<?= $priority['id'] ?>" <?= $priority['id'] == 5 ? 'selected' : '' ?>>
                      <?= $priority['id'] ?> - <?= htmlspecialchars($priority['name']) ?>
                    </option>
                  <?php endforeach; ?>
                </select>
              </div>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="location" name="location" placeholder="Meeting location, phone number, etc.">
          </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="saveEventBtn" onclick="saveEvent()">Save Event</button>
      </div>
    </div>
  </div>
</div>
