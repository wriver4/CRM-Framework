...
# Email Processing System Test Runner
# Comprehensive test execution script for all email processing tests

set -e  # Exit on any error

echo "🚀 WaveGuard Email Processing System - Test Runner"
echo "=================================================="
...
check_dependencies() {
    ...
    # Check PHPUnit
    if [ ! -f "./vendor/bin/phpunit" ] && [ ! -f "phpunit.phar" ]; then
        print_error "PHPUnit not found. Run 'composer install' or download phpunit.phar"
        exit 1
    fi
